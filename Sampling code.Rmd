...
for (i in c("0-10k","10k-100k","100k-1m","1m-10m","10m+")){
  ...
  for (j in c("North East","North West","Yorkshire & the Hum","East Midlands","West Midlands","East of England","London","South East","South West","Wales","Scotland","Unkown")){
    ...
    #Now sampling from within each size region dataset
    if(dim(get(paste0("charity.",i,".",j)))[1]<100){
      ...
      assign(paste0("sample.charity.",i,".",j),sample(select(get(paste0("charity.",i,".",j)),id)[[1]],size=ceiling(dim(get(paste0("charity.",i,".",j)))[1]*0.3)))
    }
    else if(dim(get(paste0("charity.",i,".",j)))[1]<1000){
      assign(paste0("sample.charity.",i,".",j),sample(select(get(paste0("charity.",i,".",j)),id)[[1]],size=ceiling(dim(get(paste0("charity.",i,".",j)))[1]*0.07)))
    }
    else{
      assign(paste0("sample.charity.",i,".",j),sample(select(get(paste0("charity.",i,".",j)),id)[[1]],size=100)) #sample 100
    }
