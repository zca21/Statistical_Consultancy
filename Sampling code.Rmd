...
---
```{r}
#put your working directory inside the below parenthesis
#setwd()
library(tidyverse)

#Creating dataset to match that of the client using the information from the crosstabs breakdown of variables
...
```{r}
#Creating crosstabulations, these have same info as plots but are harder to understand thus reccomend using the plots only
...
round(table_sample_freq/table_actual_freq,3)%>%
  kableExtra::kable()%>%
  kableExtra::kable_classic()
```
