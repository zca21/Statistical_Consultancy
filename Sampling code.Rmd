...
```{r}
# Creating sample diagnostic funxction to find average absoulte percent difference in income between estimated income using the sample and the true income
...
#writexl::write_xlsx(sample.diagnostics[[1]],"Sample region strata diagnostics.xlsx")
#writexl::write_xlsx(sample.diagnostics[[2]],"Sample size strata diagnostics.xlsx")
```
